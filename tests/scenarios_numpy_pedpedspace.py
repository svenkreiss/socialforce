...
def test_separator():
    ...
    # visualize
    with visualize(states, space, 'docs/separator_numpy.gif') as ax:
        ax.set_xlim(-10, 10)
...
def test_gate():
    ...
    with visualize(states, space, 'docs/gate_numpy.gif') as _:
        pass
...
def test_walkway(n):
    ...
    with visualize(states, space, 'docs/walkway_numpy_{}.gif'.format(n)) as _:
        pass
